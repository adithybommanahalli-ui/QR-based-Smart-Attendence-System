...
const navItems = [
  ...
  { href: "/student/attendance", icon: QrCode, label: "Mark Attendance" },
    ...
    >
      <div className="flex h-full flex-col">
        ...
        <div className="px-3 py-4 border-t border-border/30">
          ...
          >
            <div className="h-10 w-10 rounded-full bg-secondary/20 border border-secondary/30 flex items-center justify-center text-sm font-semibold text-secondary shrink-0">
              EZ
            </div>
            {!isCollapsed && (
              <div className="flex-1 min-w-0">
                <p className="font-medium truncate">Emily Zhang</p>
                <p className="text-xs text-muted-foreground truncate">CS101 - Section A</p>
              </div>
            )}
          </div>
